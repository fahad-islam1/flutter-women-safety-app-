                    ...
                    child: Column(
                      children: [
                        CustomTextField(
                          ...
                          onsave: (name) {
                            registerViewModel.formdata['name'] = name ?? "";
                          },
                        ),
                        ...
                        CustomTextField(
                          ...
                          onsave: (phone) {
                            registerViewModel.formdata['phone'] = phone ?? "";
                          },
                        ),
                        SizedBox(height: size.height * 0.02),
                        CustomTextField(
                          ...
                          onsave: (email) {
                            registerViewModel.formdata['email'] = email ?? "";
                          },
                        ),
                        SizedBox(height: size.height * 0.02),
                        CustomTextField(
                          ...
                          validate: (gemail) {
                            if (gemail!.isEmpty ||
                                gemail.length < 3 && gemail.contains('@')) {
                              return 'Enter correct guardian email';
                            }
                            return null;
                          },
                          onsave: (gemail) {
                            registerViewModel.formdata['gemail'] = gemail ?? "";
                          },
                        ),
                        SizedBox(height: size.height * 0.02),
                        CustomTextField(
